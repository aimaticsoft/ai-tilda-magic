...
const ContactsSection = () => {
  ...
  const contactItems = [
    { icon: Phone, label: t(translations.contacts.phone, lang), value: "8 929 384-48-44", href: "tel:+7929384484444" },
    {
      ...
      value: "info@aimaticsoft.ru",
      href: "mailto:info@aimaticsoft.ru",
    },
    {
      icon: MapPin,
      label: t(translations.contacts.address, lang),
      value: t(translations.contacts.addressValue, lang),
      href: null,
    },
  ];
  ...
  const formFields = [
    {
      name: "name",
      label: t(translations.contacts.nameLabel, lang),
      type: "text",
      placeholder: t(translations.contacts.namePlaceholder, lang),
    },
    {
      name: "phone",
      label: t(translations.contacts.phoneLabel, lang),
      type: "tel",
      placeholder: t(translations.contacts.phonePlaceholder, lang),
    },
  ];
          ...
          >
            ...
            >
              <motion.div
                ...
                animate={{ borderColor: focusedField ? "rgba(59, 130, 246, 0.5)" : "rgba(59, 130, 246, 0.2)" }}
              ...
              >
                <label className="block text-sm text-muted-foreground mb-2">
                  {t(translations.contacts.messageLabel, lang)}
                </label>
                <motion.textarea
                  rows={4}
                  ...
                  placeholder={t(translations.contacts.messagePlaceholder, lang)}
                  whileFocus={{ scale: 1.01 }}
                />
              </motion.div>
                ...
                >
                  {isSubmitting ? (
                    <>
                      ...
                      {t(translations.contacts.submitting, lang)}
                    </>
                  ) : (
                    t(translations.contacts.submit, lang)
                  )}
                </motion.button>
              </MagneticButton>
